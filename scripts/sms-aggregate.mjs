...
//
// 운영 서버에서 05시 집계를 트리거하기 위한 스크립트
// 사용 예)
//   node scripts/sms-aggregate.mjs
//   BASE_DATE=2026-02-19 node scripts/sms-aggregate.mjs
//
...
async function main() {
  ...
  const res = await fetch(url, {
    ...
    body: JSON.stringify({ baseDate: baseDate || undefined }),
  });
