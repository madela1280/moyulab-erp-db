...
/**
 * POST /api/devices/lactina/export
...
export async function POST(req: Request) {
  try {
    ...
    for (const row of filtered) {
      ...
      const rentalInfo = deviceNo ? infoByDeviceNo[deviceNo] : undefined;
    ...
    return new NextResponse(csv, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="lactina.csv"`,
      },
    });
  } catch (e) {
    console.error("POST /api/devices/lactina/export error:", e);
