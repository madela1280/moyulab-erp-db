...
/**
 * POST /api/devices/swingMaxi/export
  ...
  try {
    ...
    return new NextResponse(csv, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="swingMaxi.csv"`,
      },
    });
  } catch (e) {
    console.error("POST /api/devices/swingMaxi/export error:", e);
