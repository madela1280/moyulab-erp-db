...
/**
 * POST /api/devices/simile/export
  ...
  try {
    ...
    return new NextResponse(csv, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="simile.csv"`,
      },
    });
  } catch (e) {
    console.error("POST /api/devices/simile/export error:", e);
