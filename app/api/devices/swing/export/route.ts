  ...
  try {
    ...
    return new NextResponse(csv, {
      headers: {
        ...
        "Content-Disposition": `attachment; filename="swing.csv"`,
      },
    });
  } catch (e) {
    console.error("POST /api/devices/swing/export error:", e);
