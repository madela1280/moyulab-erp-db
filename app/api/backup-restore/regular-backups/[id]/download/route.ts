...
/**
 * GET /api/backup-restore/regular-backups/[id]/download
 * 선택한 정기백업 파일 다운로드
 */
export async function GET(
  ...
  try {
    ...
    const encodedName = encodeDownloadFileName(fileName || `backup_${id}.dump`);
    ...
    console.error(
      "GET /api/backup-restore/regular-backups/[id]/download error:",
      e
    );
    return NextResponse.json(
