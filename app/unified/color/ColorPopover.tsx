...
import ColorModeToggle, { type ColorApplyMode } from "@/unified/color/ColorModeToggle";

export type UnifiedSoftColor =
  | "red"
  | "yellow"
  | "blue"
  | "green"
...
type Props = {
  ...
  onClose: () => void;
  onApply: (color: UnifiedSoftColor, mode: ColorApplyMode) => void;
};

const COLORS: Array<{ key: UnifiedSoftColor; label: string; swatchClass: string }> = [
