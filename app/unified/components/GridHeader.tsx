...
function ToolButton({
  ...
  const base =
    "inline-flex items-center gap-1.5 text-xs px-2 py-1 border rounded text-slate-700";
  const normal = "bg-slate-50 border-slate-200 hover:bg-slate-100 active:bg-slate-200";
  const on = "bg-slate-200 border-slate-300 hover:bg-slate-200 active:bg-slate-300";
...
export default function GridHeader({ onAdd10, isColumnEditMode, onToggleColumnEditMode }: Props) {
  return (
