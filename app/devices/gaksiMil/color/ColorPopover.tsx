...
import ColorModeToggle, { type ColorApplyMode } from "@/devices/gaksiMil/color/ColorModeToggle";

export type GaksiMilSoftColor =
  | "red"
  | "yellow"
  | "blue"
  | "green"
...
type Props = {
  ...
  onApply: (color: GaksiMilSoftColor, mode: ColorApplyMode) => void;
};

const COLORS: Array<{ key: GaksiMilSoftColor; label: string; swatchStyle?: React.CSSProperties }> = [
