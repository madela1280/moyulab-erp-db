...
import ColorModeToggle, { type ColorApplyMode } from "@/devices/swingMaxi/color/ColorModeToggle";

export type SwingMaxiSoftColor =
  | "red"
  | "yellow"
  | "blue"
  | "green"
...
type Props = {
  ...
  onApply: (color: SwingMaxiSoftColor, mode: ColorApplyMode) => void;
};

const COLORS: Array<{ key: SwingMaxiSoftColor; label: string; swatchStyle?: React.CSSProperties }> = [
