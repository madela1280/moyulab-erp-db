...
import type { SwingMaxiRow } from "@/devices/swingMaxi/service/serviceSwingMaxi";
...
export function applySwingMaxiFilter(rows: SwingMaxiRow[], state: ColumnFilterState) {
...
export function getUniqueValuesForColumn(rows: SwingMaxiRow[], key: string) {
