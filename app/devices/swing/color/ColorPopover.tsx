...
import ColorModeToggle, { type ColorApplyMode } from "@/devices/swing/color/ColorModeToggle";

export type SwingSoftColor =
  | "red"
  | "yellow"
  | "blue"
  | "green"
...
type Props = {
  ...
  onApply: (color: SwingSoftColor, mode: ColorApplyMode) => void;
};

const COLORS: Array<{ key: SwingSoftColor; label: string; swatchStyle?: React.CSSProperties }> = [
