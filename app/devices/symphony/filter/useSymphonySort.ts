...
export type SymphonySortState = {
  key: string | null;
  dir: SortDir;
};

export function defaultSortState(): SymphonySortState {
 ...
 */
export function applySymphonySort<T extends { data: Record<string, any> }>(
  rows: T[],
  sort: SymphonySortState
): T[] {
