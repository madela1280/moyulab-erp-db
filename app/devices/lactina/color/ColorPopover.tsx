...
import ColorModeToggle, { type ColorApplyMode } from "@/devices/lactina/color/ColorModeToggle";

export type LactinaSoftColor =
  | "red"
  | "yellow"
  | "blue"
  | "green"
...
type Props = {
  ...
  onApply: (color: LactinaSoftColor, mode: ColorApplyMode) => void;
};

const COLORS: Array<{ key: LactinaSoftColor; label: string; swatchStyle?: React.CSSProperties }> = [
