...
type SimileRowLike = { id: number; data: Record<string, any> };
...
type CellStyle = {
  bg?: Exclude<SimileSoftColor, "clear">;
  fg?: Exclude<SimileSoftColor, "clear">;
};

export function buildColorBulkPatch<T extends SimileRowLike>(args: {
  rows: T[];
  viewColumns: string[];
  range: CellRange;
  color: SimileSoftColor;
  mode: ColorApplyMode;
}) {
